...
import com.annisawr.tasibdip.databinding.ActivityAdminPdBinding
import com.google.android.material.navigation.NavigationView

class AdminPdActivity : AppCompatActivity() {

    lateinit var toggle: ActionBarDrawerToggle  /* membuat menu bar */
    lateinit var drawerLayout: DrawerLayout     /* membuat menu bar */

    private lateinit var binding : AdminPdActivity

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_admin_pd)
